minetest.register_abm({
	...
	action = function(pos)
		...
		if math.random(45)==1 and minetest.get_node(pos).name=="air" then
			...
			if rnd==1 and marssurvive_aliens_max(1)==true then minetest.add_entity(pos, "marssurvive:alien_common") end
			if rnd==2 and marssurvive_aliens_max(1)==true then minetest.add_entity(pos, "marssurvive:alien_death") end
			if rnd==3 and marssurvive_aliens_max(1)==true then minetest.add_entity(pos, "marssurvive:alien_big") end
			if rnd==4 and marssurvive_aliens_max(1)==true then minetest.add_entity(pos, "marssurvive:alien_teleport") end
			if rnd==5 and marssurvive_aliens_max(1)==true then minetest.add_entity(pos, "marssurvive:alien_small") end
			if rnd==6 and marssurvive_aliens_max(1)==true then minetest.add_entity(pos, "marssurvive:alien_glitch") end
			if rnd==7 and marssurvive_aliens_max(1)==true then minetest.add_entity(pos, "marssurvive:alien_sand") end
			if rnd==8 and marssurvive_aliens_max(1)==true then minetest.add_entity(pos, "marssurvive:alien_glow") end
			if rnd==9 and marssurvive_aliens_max(1)==true then minetest.add_entity(pos, "marssurvive:alien_stone") end
			if rnd==10 and marssurvive_aliens_max(1)==true then minetest.add_entity(pos, "marssurvive:alien_warn") end
			if rnd==11 and marssurvive_aliens_max(1)==true then minetest.add_entity(pos, "marssurvive:alien_crystal") end
			return 
		end
	end,
})
